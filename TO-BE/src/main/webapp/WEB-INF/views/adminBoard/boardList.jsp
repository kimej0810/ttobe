			...
			<tbody>
				<c:forEach items="${boardList}" var="board">
					<c:if test="${board.b_type eq 'N'}">
						...
						<td><a href="/board/view?bidx=${board.bidx}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}" style="text-decoration : none; color:black;">[공지] ${board.b_title}</a></td>
					</c:if>
					<c:if test="${board.b_type eq 'G'}">
						<tr>
						<th scope="row">${board.bidx}</th>
						<td><a href="/board/view?bidx=${board.bidx}&page=${scri.page}&perPageNum=${scri.perPageNum}&searchType=${scri.searchType}&keyword=${scri.keyword}" style="text-decoration : none; color:black;">${board.b_title}</a></td>
					</c:if>
						<td>
