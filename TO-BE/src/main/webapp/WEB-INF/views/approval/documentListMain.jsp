...
<html>
	...
	<body>
		...
		<div id="waitingListGroup">
			...
			%>
					<a href="/approval/documentListMain<%= paging.makeSearch(paging.getStartPage()-1) %>">&lt;</a>
			<%
				}
				for(int i=paging.getStartPage(); i<=paging.getEndPage(); i++){
			%>
					<a href="/approval/documentListMain<%= paging.makeSearch(i) %>"><%=i %></a>
			<%		
				}
